...
//Productos
let p1 = new Producto("Whisky", "Jack Daniels", "Honey", "$4400 ARS", "/img/1.png")
let p2 = new Producto("Whisky", "Johnny Walker", "Black Label", "$4000 ARS", "/img/2.png")
let p3 = new Producto("Whisky", "Chivas Regal", "12y Blended Scotch", "$4500 ARS","/img/3.png")
let p4 = new Producto("Vino", "Finca Altamira", "Malbec 2015", "$6000 ARS", "/img/4.png")
let p5 = new Producto("Vino", "Los Haroldos", "Chardonnay 2013", "$5000 ARS", "/img/5.png")
let p6 = new Producto("Vino", "Cavit", "Cabernet Sauvignon", "$1700 ARS", "/img/6.png")
let p7 = new Producto("Vino", "Henri Lurton", "Sauvignon", "$3200 ARS", "/img/7.png")
let p8 = new Producto("Cerveza", "Andes Origen 1L", "Roja", "$170 ARS", "/img/8.png")
